...
export const BorderDecoration = ({
  ...
  return (
    <div className="container">
      <div className="upper left corner" style={{backgroundImage: `url("./assets/png/${upperLeftCorner}.png")`}}></div>
      <div className="upper right corner" style={{backgroundImage: `url("/assets/png/${upperRightCorner}.png")`}}></div>
